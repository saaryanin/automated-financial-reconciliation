...
process_files_in_parallel(netteller_files, processor_name="netteller", is_crm=False, save_clean=True)
...
process_files_in_parallel(netteller_crm_files, processor_name="netteller", is_crm=True, save_clean=True)
